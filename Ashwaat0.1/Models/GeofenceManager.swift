...
final class GeofenceMainManager: NSObject, CLLocationManagerDelegate {
    ...
    func startMonitoring() {
        ...
        // Masjid al-Haram
        addRegion(identifier: "haram_main", center: CLLocationCoordinate2D(latitude: 24.860810237081548, longitude: 46.727509656759025), radius: 150)
    ...
    private var tawafCenter: CLLocationCoordinate2D {
        return CLLocationCoordinate2D(latitude: 24.860810237081548, longitude: 46.727509656759025)
    }
